...
(function () {
    ...
    var TableActions = function (editor, lazyWire, selections) {
      ...
      var insertColumnsBefore$1 = execute(insertColumnsBefore, always, halve, lazyWire, structureModified);
      var insertColumnsAfter$1 = execute(insertColumnsAfter, always, halve, lazyWire, structureModified);
